    ...
    <View style={styles.screen}>
        ...
        renderItem={({item}) => {
          ...
          return(
            ...
            {navigation.navigate('freecoursepage',{fdata : item.data})}}>
          <View style={styles.box} key={item.id}>
            ...
            <View style={{paddingVertical:5,paddingHorizontal:10,width:(windowWidth*60)/100,justifyContent:'space-around'}}>
              ...
              <Text numberOfLines={2} style={{fontSize:11,fontFamily:"Roboto-Medium",color:'#274971',}}>
                {item.data.det}
              </Text>
